      ...
      >
        ...
        <DialogContent dividers={scroll === 'paper'}>
          <DialogContentText
            ...
            tabIndex={-1}
          >
   <p className={styles.main}> <ArticleIcon style={{marginBottom:"-5px" }}/> 
    <span style={{marginLeft:"15px", marginTop:"4px" ,color:"black", }}>  New </span> 
 ...
 <p className={styles.main}> 
  <FolderOpenIcon style={{marginBottom:"-5px" }}/>  
    <span style={{marginLeft:"8px" ,color:"black", }} >Open </span> 
     <span style={{marginLeft:"10rem" }} >Ctrl+O </span></p>

 <p className={styles.main}> 
  < ContentCopyIcon style={{marginBottom:"-5px" }}/>   
   <span style={{marginLeft:"8px" ,color:"black", }} >Make a copy</span> </p>
           <hr/>
           <p className={styles.main}> 
           ...
           < DownloadIcon  style={{marginBottom:"-5px" }}/>  
             <span style={{marginLeft:"7px" ,color:"black", }} >Download</span> 
              <ArrowRightIcon sx={{marginLeft:"10rem"}}/> </p>
           <hr/>
           <p className={styles.main}>  
           < DriveFileRenameOutlineIcon  style={{marginBottom:"-5px" }}/>
               <span style={{marginLeft:"7px" ,color:"black", }} >Rename</span>   </p>

           <p className={styles.main}>  
           < DriveFileMoveIcon  style={{marginBottom:"-5px" }}/>  
             <span style={{marginLeft:"7px" ,color:"black", }} >Move</span>   </p>
           <p className={styles.main}> 
            < AddToDriveIcon  style={{marginBottom:"-5px" }}/>   
             <span style={{marginLeft:"7px" ,color:"black", }} >Add Shortcut to Drive</span>   </p>

           <p className={styles.main}> 
            < DeleteOutlineIcon style={{marginBottom:"-5px" }}/>   
             <span style={{marginLeft:"7px" , color:"black" }} >Move to trash</span>   </p>
      

           <hr />
           <p className={styles.main}> 
           <  HistoryIcon style={{marginBottom:"-5px" }}/>   
            <span style={{marginLeft:"7px" , color:"black" }} >Version History</span>  </p>

           <p className={styles.main}> 
            < OfflinePinIcon   style={{marginBottom:"-5px" }}/>  
              <span style={{marginLeft:"7px" ,color:"black", }} >Make available offline</span>   </p>
         
           <hr/>
           <p className={styles.main}> 
            < InfoIcon  style={{marginBottom:"-5px" }}/>  
              <span style={{marginLeft:"7px" ,color:"black", }} >Details</span>   </p>

           <p className={styles.main}> 
            < LanguageIcon  style={{marginBottom:"-5px" }}/> 
               <span style={{marginLeft:"7px" ,color:"black", }} >Language</span>   </p>

           <p className={styles.main}>
              < DescriptionIcon style={{marginBottom:"-5px" }}/>   
               <span style={{marginLeft:"7px" ,color:"black", }} >Page Setup</span>   </p>

           <p className={styles.main}> 
            < PrintIcon style={{marginBottom:"-5px" }}/>  
              <span style={{marginLeft:"7px" ,color:"black", }} >Print</span>
               <span style={{marginLeft:"10rem" }} >Ctrl+P </span>  </p>
